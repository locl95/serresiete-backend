...
class BlizzardDomainTest {
    ...
    fun `i can deserialize a character stats response`() {
        assertEquals(getWowStatsResponse, json.decodeFromString<GetWowCharacterStatsResponse>(getWowStatsResponseString))
    }

    @Test
    fun `i can deserialize a character specializations response`() {
        assertEquals(getWowSpecializationsResponse, json.decodeFromString<GetWowSpecializationsResponse>(getWowSpecializationsResponseString))
    }
}